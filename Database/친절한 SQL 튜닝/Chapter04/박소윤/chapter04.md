...
- 즉, 실제 추출된 건수 만큼 서브쿼리가 반복적으로 실행된다는 의미이다.
...
- `no_unnset` - 서브쿼리를 풀어내지 말고 그대로 수행하라는 의미의 힌트
...
![[Pasted image 20240117203433.png|500]]

##### Pushing 기능 사용 후

![[Pasted image 20240117203505.png|500]]
...
![[Pasted image 20240117204249.png|500]]
##### View Merging 후
...
이렇게 최적화한 쿼리는 (1)전월 이후 가입한 고객을 대상으로 '건건이' (2)당월 거래 데이터만 읽어서 조인하고 (3) `group by`를 수행한다.
